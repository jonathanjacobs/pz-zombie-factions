...
- Standing bites, the v0.0.36 mixed-crowd crawler/stomp route, the v0.0.38 dormant-mob-member fix, and the v0.0.39 Horde Spawner first-click fix have dedicated-server runtime evidence. The v0.0.37 seated-stomp/get-up extension has server-side profile-transition evidence consistent with a working get-up but no confirming client-side counters; two-client ownership also remains follow-up work.
