...
- [`SPIKE-004 — Crawler combat profiles`](SPIKE-004-crawler-combat-profiles.md) — **Open**; v0.0.36 mixed-crowd pass, v0.0.37 sitting-defender retry awaiting validation.
- [`SPIKE-005 — Sprinter locomotion during faction pursuit`](SPIKE-005-sprinter-locomotion.md) — **Draft**; scope proposal, not yet implemented.
